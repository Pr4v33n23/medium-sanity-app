        ...
        >
          ...
          <label className="mb-5 block">
            ...
            <input
              ...
              className="orm-input mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-yellow-500 focus:ring-2"
              placeholder="John Appleseed"
              type="text"
            />
          </label>
          ...
          <input
            type="submit"
            className="focus:shadow-outline rounder cursor-pointer bg-yellow-500 py-2 px-4 font-bold 
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // after 60 seconds updates the cache.
  }
}
